  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <header className="text-center mb-16">
        <h1 className="text-4xl md:text-5xl font-bold text-primary mb-4">About NigaH</h1>
      ...
      <section className="grid md:grid-cols-2 gap-12 items-center mb-16">
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            Founded in 2023, NigaH was born from a simple idea: eyewear should be an extension of your personality, not just a necessity. We believe that finding the perfect pair of glasses can transform how you see the world and how the world sees you.
          </p>
          <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            At NigaH, we're committed to quality, style, and exceptional customer service. We partner with renowned brands and independent designers to bring you a diverse range of options, from timeless classics to the latest trends.
          </p>
        </div>
        <div className="rounded-lg overflow-hidden shadow-xl">
          <Image
            src="about us.jpeg"
            alt="NigaH Team or Storefront"
            width={600}
            height={400}
      ...
      <section className="text-center bg-card p-8 md:p-12 rounded-lg shadow-md">
        ...
        <a href="mailto:careers@nigah.com" className="inline-block px-6 py-3 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition-colors">
          View Open Positions
        </a>
      </section>
    </div>

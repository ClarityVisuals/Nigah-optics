    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-transparent">
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        <Link href="/" className="flex items-center gap-2 text-lg font-semibold">
          ...
          <div>
            <span className="text-foreground dark:text-white drop-shadow-[0_1px_1px_rgba(0,0,0,0.5)]">Ni</span><span className="text-primary drop-shadow-[0_1px_1px_rgba(0,0,0,0.5)]">ga</span><span className="text-foreground dark:text-white drop-shadow-[0_1px_1px_rgba(0,0,0,0.5)]">H</span>
          </div>
        </Link>
            ...
            <SheetContent side="right" className="bg-background">
              <nav className="grid gap-6 text-lg font-medium mt-8">
                <Link href="/" className="flex items-center gap-2 text-lg font-semibold mb-4">
                  <Glasses className="h-7 w-7 text-primary" />
                  <div>
                    <span className="text-foreground dark:text-white">Ni</span><span className="text-primary">ga</span><span className="text-foreground dark:text-white">H</span>
                  </div>
                </Link>
                {navItems.map((item) => (
                  <Link
